...
class HeteroGraphormerLayerComplete(nn.Module):
    def __init__(self, channels, edge_types, device, dropout=0.1, num_heads=4):
        super().__init__()
        self.device = device
    ...
    def forward(self, x_dict, edge_index_dict):
        ...
        for node_type in out_dict:
          out_dict[node_type] = x_dict[node_type] + self.dropout(out_dict[node_type])
          out_dict[node_type] = self.norm(out_dict[node_type])
