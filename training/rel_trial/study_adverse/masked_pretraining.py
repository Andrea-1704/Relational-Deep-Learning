...
train_map(model, loader_dict, maskable_attributes, encoder_out_dim=128, device=device, cat_values = cat_values, epochs=20, col_stats_dict=col_stats_dict, db=db_nuovo)
