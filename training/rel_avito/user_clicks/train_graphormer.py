#####
# Heterogeneous Graph SAGE — multi-seed (best Test ROC-AUC per seed)
# Mantiene la struttura di chiamata originale
####
...
# ---------------------------
# y e train_mask per il node_type/target
# ---------------------------
...
labels_np = train_df_raw[target].to_numpy().astype(np.float32)  # se binario 0/1
...
# BCEWithLogitsLoss con pos_weight (come da tuo script)
...
for seed in seeds:
    # fissiamo i seed senza cambiare la struttura delle funzioni
    ...
    for epoch in range(1, epochs + 1):
        ...
        # >>> best test assoluto (quello che useremo per media/std)
    ...
    # fine seed: ricarico checkpoint best-test e riconfermo il numero
