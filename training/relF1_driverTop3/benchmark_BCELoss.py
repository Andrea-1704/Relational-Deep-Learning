...
from model.XMetaPath_BCELoss import XMetaPath2, make_criterion_from_train_labels
...
# criterion, loss_info = make_criterion_from_train_labels(
#     y_train=y_full.to(device),
#     device=device,
#     mode="auto",          # "auto" usa Focal se pos% < 10%, altrimenti BCE
