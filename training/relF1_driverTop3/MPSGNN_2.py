...
from model.MPSGNN_Model2 import MPSGNN_Original
...
def train2():
    ...
    relation_to_index = {
        rel: i for i, rel in enumerate(data_official.metadata()[1])
    }
    ...
    metapaths_triples = [[('drivers', 'rev_f2p_driverId', 'qualifying'), ('qualifying', 'f2p_constructorId', 'constructors')],
                     [('drivers', 'rev_f2p_driverId', 'qualifying'), ('qualifying', 'f2p_raceId', 'races')],
                     [('drivers', 'rev_f2p_driverId', 'results'), ('results', 'f2p_raceId', 'races'), ('races', 'f2p_circuitId', 'circuits')]]

    metapaths_indices = [
        [relation_to_index[rel] for rel in path]
        for path in metapaths_triples
    ]
